...
Note: Spring 5.0.5 release is the foundation for the upcoming Spring Boot 2.0.1 
...
JPA是基于ORM（对象关系映射）的，把代码和对象分离，相当于在代码和DB之间增加了一个新的层面，一套新的标准，去间接的操作DB
