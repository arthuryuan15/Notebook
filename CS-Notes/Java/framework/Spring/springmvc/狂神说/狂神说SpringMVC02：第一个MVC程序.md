https://mp.weixin.qq.com/s?__biz=Mzg2NTAzMTExNg==&mid=2247483978&idx=1&sn=6711110a3b2595d6bb987ca02ee0a728&scene=19#wechat_redirect
...
4、编写SpringMVC 的 配置文件！（在resource里面新建）名称：springmvc-servlet.xml  : [servletname]-servlet.xml
...
5、添加 处理映射器 （spring写的直接用）

```xml
<bean class="org.springframework.web.servlet.handler.BeanNameUrlHandlerMapping"/>
```

6、添加 处理器适配器（spring写的直接用）

```xml
<bean class="org.springframework.web.servlet.mvc.SimpleControllerHandlerAdapter"/>
```

7、添加 视图解析器（spring写的直接用）
...
9、将自己的类交给SpringIOC容器，注册bean （配到springmvc-servlet.xml）
...
![img](https://p.ipic.vip/cmy2gs.jpg)
...
![img](https://p.ipic.vip/ol0u2g.jpg)
...
![img](https://p.ipic.vip/vlb5p3.jpg)
...
![img](https://p.ipic.vip/aj1ykw.jpg)
