...
可以看出，`interval` 这个类变量(是在准备的时候加载并赋予默认值)，我们是打算在执行完 `Configuration.getInt("interval");` 把这个结果赋值给它的。但是 在准备阶段是不会执行这句代码的 。而这句代码是在 **初始化** 阶段 执行。
...
![类加载器的层级.jpg](https://p.ipic.vip/2kkrhi.jpg)
...
![Screen Shot 2019-09-27 at 5.04.59 PM](https://p.ipic.vip/h4syos.jpg)
...
```
 ...
 ![Screen Shot 2019-09-27 at 4.48.36 PM](https://p.ipic.vip/482lol.jpg)
...
![Screen Shot 2019-09-27 at 5.13.33 PM](https://p.ipic.vip/trbih6.jpg)
...
![Screen Shot 2019-09-27 at 9.00.52 PM](https://p.ipic.vip/kolnj9.jpg)
...
![Screen Shot 2019-09-27 at 9.55.52 PM](https://p.ipic.vip/z9srk9.jpg)
...
![Screen Shot 2019-09-27 at 10.19.56 PM](https://p.ipic.vip/h2tihx.jpg)
...
![Screen Shot 2019-09-28 at 9.15.40 AM](https://p.ipic.vip/nrj59i.jpg)
...
![Screen Shot 2019-09-28 at 10.07.54 AM](https://p.ipic.vip/u0uaoz.jpg)
...
![Screen Shot 2019-09-28 at 10.21.19 AM](https://p.ipic.vip/gzfyru.jpg)
...
![image-20220401075145796](https://p.ipic.vip/qgsm53.jpg)
...
![Screen Shot 2019-09-28 at 10.33.46 AM](https://p.ipic.vip/ww9ckm.jpg)
...
![image_26691](https://p.ipic.vip/9pi0kj.jpg)
...
1.   An abstract class **cannot** be used to create objects.

2.   An abstract class **can** contain abstract methods, which are implemented in subclasses.
